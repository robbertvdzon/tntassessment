...
class AggregationRequestParserTest {
    ...
    public void testPricingNull(){
        Exception exception = Assertions.assertThrows(InvalidAggregationRequestException.class, () -> {
            AggregationRequestParser.parseRequest(null, "109347263,123456891", "109347263,123456891");
        });
    ...
    public void testTrackingNull(){
        Exception exception = Assertions.assertThrows(InvalidAggregationRequestException.class, () -> {
            AggregationRequestParser.parseRequest("NL,CN", null, "109347263,123456891");
        });
    ...
    public void testShipmentNull(){
        Exception exception = Assertions.assertThrows(InvalidAggregationRequestException.class, () -> {
            AggregationRequestParser.parseRequest("NL,CN", "109347263,123456891", null);
        });
    ...
    public void testInvalidCountryCode(){
        Exception exception = Assertions.assertThrows(InvalidAggregationRequestException.class, () -> {
            AggregationRequestParser.parseRequest("NL,XX", "109347263,123456891", "109347263,123456891");
        });
    ...
    public void testOrderNumberTooShort(){
        Exception exception = Assertions.assertThrows(InvalidAggregationRequestException.class, () -> {
            AggregationRequestParser.parseRequest("NL,CN", "10934726,123456891", "109347263,123456891");
        });
    ...
    public void testOrderNumberTooLong(){
        Exception exception = Assertions.assertThrows(InvalidAggregationRequestException.class, () -> {
            AggregationRequestParser.parseRequest("NL,CN", "1093472633,123456891", "109347263,123456891");
        });
    ...
    public void testOrderNumberNotNumber(){
        Exception exception = Assertions.assertThrows(InvalidAggregationRequestException.class, () -> {
            AggregationRequestParser.parseRequest("NL,CN", "10934726A,123456891", "109347263,123456891");
        });
